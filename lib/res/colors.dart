...
class ColorsRes {
  /// Main colors
  static const primary = Color(0xFFFF0358);
  ...
  static const backgroundTheme = Color(0xFFFDE5FA);
  static const backgroundThemeOld = Color(0x33ff7fac);
  static const warning = Color(0xFFF1DC3E);
  static const error = Color(0xFFF03738);
  static const pinkCard = Color(0xFFFFDDE9);
  static const greenCard = Color(0xFFEFFFFF);
  ...
  static const pointColor = Color(0XFFFC0358);
